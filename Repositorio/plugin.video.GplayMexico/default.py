...
Base = 'https://gplaymex.blogspot.com/2019/03/add-on-gplaymexico.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.GplayMexico') #    modificar("el nombre de tu addons")
